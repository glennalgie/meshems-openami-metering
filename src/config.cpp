...
int MQTTPublish_subpanel_rate = 300000;      // subpanel_3Ph: 5min
int MQTTPublish_meter_group_rate = 120000;   // meter_0..meter_n: 2min
int MQTTPublish_env_rate = 900000;           // subpanel_ENV: 15 min
...
int MQTTPublish_harmonics_rate = 9000000;    // subpanel_harmonics: 15 min
int MQTTPoll_rate = 60000;           // hack: MQTT client loop / keepalive every 1min
